...
function loadIFrame(url) {
	...
	document.getElementById("imgModalBody").innerHTML = '<iframe src="' + url + '"></iframe>';
	document.getElementById("imgModalFooter").innerHTML = '<p><a data-dismiss="modal" class="btn btn-primary" href="' + url + '" target="_BLANK">Visit website</a>';
}
